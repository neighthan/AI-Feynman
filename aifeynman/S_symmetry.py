            ...
            for i in range(0, n_variables, 1):
                for j in range(0, n_variables, 1):
                    if i < j:
                        ...
                        a = 0.5 * min(
                            torch.std(fact_translate[:, i]),
                            torch.std(fact_translate[:, j]),
                        )
    ...
    try:
        ...
        with torch.no_grad():
            ...
            remove_input_neuron(
                ...
                + filename
                + "-translated_minus_pretrained.h5",
            )
    ...
    try:
        ...
        with torch.no_grad():
            ...
            remove_input_neuron(
                ...
                "results/NN_trained_models/models/"
                + filename
                + "-translated_divide_pretrained.h5",
            )
    ...
    try:
        ...
        with torch.no_grad():
            ...
            remove_input_neuron(
                ...
                "results/NN_trained_models/models/"
                + filename
                + "-translated_multiply_pretrained.h5",
            )
